...
/*管理员*/
CREATE TABLE LittleVC_admin(
  aid INT PRIMARY KEY AUTO_INCREMENT,
  aname VARCHAR(32) UNIQUE,
  apwd VARCHAR(64)
);
INSERT INTO LittleVC_admin VALUES
(NULL, 'admin', PASSWORD('123456')),
(NULL, 'boss', PASSWORD('999999'));

/*全局设置*/
CREATE TABLE LittleVC_settings(
...
/*桌台预定信息*/
CREATE TABLE LittleVC_reservation(
  ...
  dinnerTime BIGINT,
  tableId INT,
  FOREIGN KEY(tableId) REFERENCES LittleVC_table(tid)
);
INSERT INTO LittleVC_reservation VALUES
...
/*菜品类别*/
CREATE TABLE LittleVC_category(
  cid INT PRIMARY KEY AUTO_INCREMENT,
  cname VARCHAR(32)
);
INSERT INTO LittleVC_category VALUES
(1, '肉类'),
(2, '海鲜河鲜'),
(3, '丸滑类'),
(4, '蔬菜豆制品'),
...
CREATE TABLE LittleVC_dish(
  ...
  detail VARCHAR(128),
  categoryId INT,
  FOREIGN KEY(categoryId) REFERENCES LittleVC_category(cid)
);
INSERT INTO LittleVC_dish VALUES
...
INSERT INTO LittleVC_order VALUES
...
/*订单详情*/
CREATE TABLE LittleVC_order_detail(
  oid INT PRIMARY KEY AUTO_INCREMENT,
  dishId INT,       /*菜品编号*/
  dishCount INT,    /*份数*/
  customerName VARCHAR(32),    /*顾客名称*/
  orderId INT,      /*订单编号*/
  FOREIGN KEY(dishId) REFERENCES LittleVC_dish(did),
  FOREIGN KEY(orderId) REFERENCES LittleVC_order(oid)
);
INSERT INTO LittleVC_order_detail VALUES
(NULL, '50', '2', '丁丁', '100000'),
(NULL, '24', '2', '丁丁', '100001'),
(NULL, '37', '1', '当当', '100002'),
(NULL, '18', '3', '豆豆', '100003'),
